...
internal sealed class LapDataPacketDeserializer : IPacketDeserializer
{
    public byte PacketId => (byte)F1PacketId.LapData;
    ...
    public object? Deserialize(ReadOnlySpan<byte> data, TelemetryPacketHeader header)
    {
        ...
        {
            LapDataItems = new LapData[Format2026Constants.MaxCarsInUdpData]
        };
