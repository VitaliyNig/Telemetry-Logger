...
/// <summary>
/// Stateful span-based binary reader for little-endian F1 2026 packet data.
/// Tracks an offset and provides typed reads for all F1 data types.
///
/// Mirror of <c>BinaryReader125</c> in the Format2025 assembly. Kept format-local so future
/// quirks (e.g. a new array-size variant) can land here without touching the other format.
/// </summary>
internal ref struct BinaryReader126
{
    private readonly ReadOnlySpan<byte> _data;
    private int _offset;

    public BinaryReader126(ReadOnlySpan<byte> data, int startOffset = 0)
    {
        _data = data;
        _offset = startOffset;
    }
