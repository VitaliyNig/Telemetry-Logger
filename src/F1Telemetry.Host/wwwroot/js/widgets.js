...
const WIDGET_REGISTRY = {
    ...
    standings:    { title: "Standings",            tpl: "tpl-standings",    w: 10,  h: 10,  minW: 1,    minH: 1 },
    ...
    qualiStandings:   { title: "Quali Standings",    tpl: "tpl-qualiStandings",     w: 10,  h: 10,  minW: 1, minH: 1 },
    ...
    lapTimes:         { title: "Lap Times",            tpl: "tpl-lapTimes",         w: 10,  h: 10,  minW: 1, minH: 1 },
    pitStopTimer:     { title: "Pit Stop Timer",       tpl: "tpl-pitStopTimer",     w: 4,   h: 9,   minW: 1, minH: 1 },
};
...
function makeWidgetHtml(widgetId) {
    ...
    if (widgetId === "events") {
        ...
        headerExtra = `<button type="button" class="event-filter-toggle" id="btnCarTelemetrySettings" title="Shift RPM calibration"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg></button>`;
...
function wireWidgetEvents(widgetId) {
    ...
    if (widgetId === "telemetry" && typeof initCarTelemetrySettingsPanel === "function") {
        initCarTelemetrySettingsPanel();
    }
}
